...
const recompensasMock = [
  {
    ...
    descripcion: 'Un día libre adicional para descansar',
    icono: '🏖️',
    coste: 500,
  ...
  },
  {
    ...
    descripcion: 'Almuerzo en restaurante selecto',
    icono: '🍽️',
    coste: 300,
  ...
  },
  {
    id: 4,
    titulo: 'Curso Online',
    descripción: 'Acceso a curso de desarrollo personal',
    icono: '📚',
    coste: 1000,
    categoria: 'educación',
    popularidad: 4,
  ...
  {
    id: 5,
    titulo: 'Kit de Bienestar',
    descripcion: 'Set de productos para el cuidado personal',
    icono: '🧴',
    coste: 600,
    categoria: 'bienestar',
    popularidad: 3,
  ...
  },
  {
    ...
    descripcion: 'Clase privada de yoga y meditación',
    icono: '🧘‍♀️',
    coste: 400,
    categoria: 'bienestar',
    popularidad: 5,
...
const cargarRecompensas = async () => {
  ...
  try {
    ...
    recompensas.value = recompensasMock
  } catch (err) {
