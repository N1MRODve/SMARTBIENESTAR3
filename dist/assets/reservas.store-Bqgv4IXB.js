import{A as c,d as n}from"./vue-vendor-DLSXyIw7.js";import{s as t}from"./index-D33O_vwf.js";const l={async getAll(){const{data:r,error:e}=await t.from("reservas_sesiones").select(`
        *,
        sesion:sesiones (
          *,
          servicio:servicios (
