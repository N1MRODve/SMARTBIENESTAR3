...
<template>
  <div class="space-y-8">
    ...
    <!-- Info Banner: Cómo Funcionan los Puntos -->
    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6 shadow-md">
      <div class="flex items-start">
        ...
        <div class="flex-1">
          <h3 class="text-lg font-bold text-blue-900 mb-2">Sistema de Puntos de Bienestar</h3>
          <p class="text-sm text-blue-800 mb-3">Los empleados acumulan puntos automáticamente al participar en actividades de bienestar:</p>
          <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mb-3">
            <div class="bg-white rounded-lg p-3 border border-blue-200">
              <p class="text-xl font-bold text-blue-600">+100 pts</p>
              <p class="text-xs text-blue-800">Encuesta completada</p>
            </div>
            <div class="bg-white rounded-lg p-3 border border-blue-200">
              <p class="text-xl font-bold text-blue-600">+150 pts</p>
              <p class="text-xs text-blue-800">Respuesta rápida (&lt;24h)</p>
            </div>
            <div class="bg-white rounded-lg p-3 border border-blue-200">
              <p class="text-xl font-bold text-blue-600">+200 pts</p>
              <p class="text-xs text-blue-800">Participación mensual</p>
            </div>
            <div class="bg-white rounded-lg p-3 border border-blue-200">
              <p class="text-xl font-bold text-blue-600">+75 pts</p>
              <p class="text-xs text-blue-800">Asistencia a eventos</p>
            </div>
            <div class="bg-white rounded-lg p-3 border border-blue-200">
              <p class="text-xl font-bold text-blue-600">+300 pts</p>
              <p class="text-xs text-blue-800">Sugerencia implementada</p>
            </div>
            <div class="bg-white rounded-lg p-3 border border-blue-200">
              <p class="text-xl font-bold text-blue-600">+50 pts</p>
              <p class="text-xs text-blue-800">Referir empleado</p>
            </div>
          </div>
          <p class="text-xs text-blue-700">💡 Los empleados pueden canjear sus puntos por las recompensas que configures aquí.</p>
        </div>
      </div>
    </div>
