/*
  ...
  2. Security
    ...
    - Policy for super admins to read their own data
    - Policy for super admins to read all platform users
    - Policy for super admins to read all empresas
    - Policy for super admins to read all solicitudes

  3. Notes
    - This table is independent from `empleados` table
    - Super admins are internal SMART Bienestar team members
    - They do not belong to any client company
*/
...
-- Create RLS policies for super admins to access empresas (read all)
...
-- Create RLS policies for super admins to access empleados (read all)
